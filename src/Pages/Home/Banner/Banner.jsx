...
import bannerImg from '../../../assets/banner/7.jpg';
...
const Banner = () => {
    return (
        <section style={{ backgroundImage: `url('${bannerImg}')`, backgroundSize: 'cover', }} className='h-screen  flex items-center bg-fixed'>
            ...
            <div className='pl-10 '>
                <h1 className='text-4xl md:text-5xl font-bold text-white space-x-1'>Raining Offers For <br /> Hot Summer!</h1>
                <h3 className='text-2xl font-semibold py-10'>25% Off On All Products</h3>
                <div>
